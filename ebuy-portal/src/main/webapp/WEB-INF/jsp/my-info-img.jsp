    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
            <div class="mod-main">
						<div class="mt">
							<ul class="extra-l">
								<li class="fore-1"><a class="base-info" href="javascript:void(0);">基本信息</a></li>
                                <li class="fore-2"><a class="curr img-info" href="javascript:void(0);">头像照片</a></li>
                                <li class="fore-3"><a class="more-info" href="javascript:void(0);">更多个人信息</a></li>
						...
						<div class="mc update-face-cont">
							<div class="update-lcol">
								...
								<div class="img-b-cont img-cont ">
									...
									<div class="img-b">
										<img id="bigImage" name="bigImage" alt="" width="150" height="150" src="<%=request.getContextPath() %>/images/defaultImgs/1.jpg">
									</div>
								</div>
								<div class="smt"><h3>推荐头像</h3></div>
								<div class="smc face-list">
									<ul class="imgUl">
										<li value="1"><img src="<%=request.getContextPath() %>/images/defaultImgs/1.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="2"><img src="<%=request.getContextPath() %>/images/defaultImgs/2.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="3"><img src="<%=request.getContextPath() %>/images/defaultImgs/3.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="4"><img src="<%=request.getContextPath() %>/images/defaultImgs/4.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="5"><img src="<%=request.getContextPath() %>/images/defaultImgs/5.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="6"><img src="<%=request.getContextPath() %>/images/defaultImgs/6.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="7"><img src="<%=request.getContextPath() %>/images/defaultImgs/7.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="8"><img src="<%=request.getContextPath() %>/images/defaultImgs/8.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="9"><img src="<%=request.getContextPath() %>/images/defaultImgs/9.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="10"><img src="<%=request.getContextPath() %>/images/defaultImgs/10.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="11"><img src="<%=request.getContextPath() %>/images/defaultImgs/11.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="12"><img src="<%=request.getContextPath() %>/images/defaultImgs/12.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="13"><img src="<%=request.getContextPath() %>/images/defaultImgs/13.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="14"><img src="<%=request.getContextPath() %>/images/defaultImgs/14.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="15"><img src="<%=request.getContextPath() %>/images/defaultImgs/15.jpg" alt="" width="50" height="50"><b></b></li>
										<li value="16"><img src="<%=request.getContextPath() %>/images/defaultImgs/16.jpg" alt="" width="50" height="50"><b></b></li>
									</ul>
									<div class="btns mt20">
							...
							<div class="update-rcol">
								...
								<div class="smc">
									...
									<div class="img-m-cont img-cont">
										<div class="img-s">
									    <img id="midImage" width="100" height="100" name="midImage" src="<%=request.getContextPath() %>/images/defaultImgs/1.jpg">
                                        </div>
									</div>
									100*100像素
									<div class="img-s-cont img-cont">
										<div class="img-s">
										<img id="smaImage" width="50" height="50" name="smaImage" src="<%=request.getContextPath() %>/images/defaultImgs/1.jpg">
                                        </div>
									</div>
									50*50像素
								</div>
