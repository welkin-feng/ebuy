    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
			...
			<div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                <li class="fore-1"><a class="curr base-info" href="javascript:void(0);">基本信息</a></li>
                                <li class="fore-2"><a class="img-info" href="javascript:void(0);">头像照片</a></li>
                        ...
                        <div class="mc">
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="radio" name="sex" class="jdradio" value="0" checked><label class="mr10">男</label>
                            ...
                            <div id="user-info">
                                <div class="u-pic">
                                    <img alt="用户头像" src="<%=request.getContextPath() %>/images/defaultImgs/1.jpg">
                                    <div class="mask"></div>
