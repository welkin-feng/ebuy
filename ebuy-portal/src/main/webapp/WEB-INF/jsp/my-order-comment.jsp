                                                    ...
                                                    <div class="p-info clearfix">
                                                        <div class="p-img fl">
                                                            <a target="_blank" href="http://item.jd.com/975788.html">
                                                                <img width="50" height="50" title="佳能（Canon） MG2400 超值彩色喷墨一体机（打印 复印 扫描）" data-img="1" src="<%=request.getContextPath() %>/images/rBEhV1I2yiUIAAAAAADKL7RWKf8AADQDQOQekkAAMpH341.jpg" class="err-product">
                                                            </a>
                                                        </div>
                                                        <div class="p-name fl">
                                                ...
                                                <div class="form" tagflag="true" isconspros="0" pid="975788">
                                                    ...
                                                    <div class="isL item">
                                                        ...
                                                        <div class="fl">
                                                            ...
                                                            <img class="seccodeimg" height="28" alt="" src="<%=request.getContextPath() %>/images/yzm.jpg">
