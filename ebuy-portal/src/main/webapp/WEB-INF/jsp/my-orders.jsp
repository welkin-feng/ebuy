...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/myjd.common.css" media="all" />
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/myjd.order.css" media="all" />
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquery-1.6.4.js"></script>
</head>
<body>
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/js/base-2011.js" charset="utf-8"></script>
	<!-- header start -->
						...
						<div class="mod-main mod-comm lefta-box" id="order02">
							...
							<div class="mc">
								<table class="tb-void">
									...
									<c:forEach items="${orderlist}" var="order" varStatus="rr">
										<tbody id="tb-2538292730">
											...
											<tr id="track2538292730" oty="0,1,70" class="tr-td">
												<td>
													<div class="img-list">
														<c:forEach items="${itemlistlist[rr.index]}" var="item">
															<img  title="${item.title }" width="50" height="50"
															src="${item.picPath }" class="err-product">
														</c:forEach>
													</div>
												</td>
												<td><div class="u-name">${order.buyerNick }</div></td>
												<td>￥${order.payment }<br> 货到付款<br></td>
												<td><span class="ftx-03">2017-${order.createTime.month+1 }-${order.createTime.date } <br>
															${order.createTime.hours }:${order.createTime.minutes }:${order.createTime.seconds }</span> <input type="hidden" id="datasubmit-2538292730"
							...
							<dd class="fore4 last ">
								<div class="item" id="_MYJD_history">
									<a target="_blank" clstag="homepage|keycount|home2013|hll"
										...
										width="24" height="11" src="/portal/images/myjd-new-ico.png"></a>
								</div>
							</dd>
						</dl>
						<dl class="fore8">
