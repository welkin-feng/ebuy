...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/purchase.base.2012.css" />
   <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/css/purchase.sop.css" />
   <title>订单成功页面</title>
   ...
   <script type="text/javascript" src="<%=request.getContextPath() %>/js/jquery.cookie.js" charset="utf-8"></script>
